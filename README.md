...
| Statsig | Build-Ship-Measure-Learn Loop | Clickable 4-stage loop mapping each stage of the Statsig loop to the surface that does its job | `statsig/statsig-101/01_the-loop_build-ship-measure-learn/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/statsig-101/01_the-loop_build-ship-measure-learn/) |
...
| Statsig | Gate vs Dynamic Config | Toggle a gate on/off vs. changing config values, showing boolean switch vs. tunable behavior | `statsig/statsig-101/02_ship-safely_gate-vs-config/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/statsig-101/02_ship-safely_gate-vs-config/) |
| Statsig | Hypothesis Builder | Assemble a hypothesis from action + predicted outcome + rationale, and see what breaks when a part is missing | `statsig/statsig-101/03_measure_hypothesis-builder/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/statsig-101/03_measure_hypothesis-builder/) |
| Statsig | Duration Calculator | Effect-size and traffic sliders showing sample size ÷ daily traffic = days to run | `statsig/statsig-101/03_measure_duration-calculator/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/statsig-101/03_measure_duration-calculator/) |
...
| Statsig | Investigation Chain | Animated Pulse to funnel split to session replay chain: what moved, where, and why | `statsig/analytics-session-replay/00_opening_investigation-chain/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/00_opening_investigation-chain/) |
| Statsig | Chart Picker | Click a question to see which Metrics Explorer chart answers it | `statsig/analytics-session-replay/01_metrics-explorer_chart-picker/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/01_metrics-explorer_chart-picker/) |
| Statsig | Auto-Populating Dashboard | Tag-driven dashboard that adds a card when a teammate ships a matching experiment | `statsig/analytics-session-replay/01_metrics-explorer_auto-dashboard/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/01_metrics-explorer_auto-dashboard/) |
| Statsig | Compounding Attrition | Steps and per-step conversion sliders showing why long funnels bleed to a low finish | `statsig/analytics-session-replay/02_funnel_compounding-attrition/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/02_funnel_compounding-attrition/) |
| Statsig | Funnel Divergence | Animated control vs treatment funnel that pulls apart at the checkout-started step | `statsig/analytics-session-replay/02_funnel_divergence/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/02_funnel_divergence/) |
| Statsig | Lifecycle vs Retention | Flat DAU that reveals a rotting recurring base when you break it into lifecycle segments | `statsig/analytics-session-replay/02_funnel_lifecycle-vs-retention/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/02_funnel_lifecycle-vs-retention/) |
| Statsig | Session Replay Rewind Buffer | Timeline showing the 30-second buffer saved before a trigger fires | `statsig/analytics-session-replay/03_replay_rewind-buffer/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/03_replay_rewind-buffer/) |
| Statsig | Recording Gate Nesting | Toggle the targeting gate and trigger to see whether a session gets recorded | `statsig/analytics-session-replay/03_replay_targeting-gate-nesting/` | [link](https://nlivni-amplitude.github.io/academy-interactives/statsig/analytics-session-replay/03_replay_targeting-gate-nesting/) |
